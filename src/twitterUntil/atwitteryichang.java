...
public class atwitteryichang{
            //专门处理异常网页（顶部是评论，点开查询下一页）的一个类。
	public static void main(String[] args){

       //        atwitteryichang.yichang(chus,ss);		
	
              }
		
		
		public static void yichang(String chus ,String ss ){
				 ...
				 builder.setUserAgent("Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.99 Safari/537.36");   //设置UA字段，UA标识浏览器身份	       
							...
							/*    	 if (rawHtml.contains(<>)) {
						       ...
						       String  LastId =coo6[coo6.length-1] ;
								...
								}catch(Exception e){    //e.printStackTrace();                                             //这几行是一种catch方法。
							                           System.out.println("改行出现错误。");                            
