...
public class twitterYichang {

	public static void ychang(String ycid, String ss) {
		// TODO 自动生成的方法存根
	    ...
	    Connection conna = ConnectJDBC.getConnection();  
			...
			PreparedStatement	 sql=conna.prepareStatement("insert into TwitterShiyan values(? ,? , ? ,? ,? )");     	                                    
					         ...
					         System.out.println("这是个异常网页，已经争取读取把"+ycid+"数据存储在了twitter数据库");   
