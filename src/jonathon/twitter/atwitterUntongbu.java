...
public class atwitterUntongbu implements Runnable {

	public void run() {

	    Logger logger =Logger.getLogger(atwitterUntongbu.class);    //配置日志
	...
	try {	  //如果这一行出错，将会跳过这一个。
		            	ss = ssc[iaa]; 		
					  	 ...
					  	 csql=conna.prepareStatement("select * from twitter where userId = ? ");     	                                    
		                     ...
		                     System.out.println("读取成功，现在正在扫描的是："+ss);
		                     logger.warn("读取到了："+ss);
	           ...
	           } catch (Exception e) {System.out.println("跳过该数据，不能让线程轻易停止。"); }//主要是防止同步块出问题。   
	   }		//遍历每一个用户id；
	...
	public static void main(String[] args){
		System.out.println("Start~");
		   ...
		   atwitterUntongbu  atw1 =new atwitterUntongbu();
		   atwitterUntongbu  atw2 =new atwitterUntongbu();
		   atwitterUntongbu  atw3 =new atwitterUntongbu();
		   atwitterUntongbu  atw4 =new atwitterUntongbu();
		   atwitterUntongbu  atw5=new atwitterUntongbu();
		   atwitterUntongbu  atw6 =new atwitterUntongbu();
		   atwitterUntongbu  atw7 =new atwitterUntongbu();
		   atwitterUntongbu  atw8 =new atwitterUntongbu();
